titles=["Meaningful and Focused WORKSHOPS","Discover the limitless possibilities","Ignite, Explore, Excel.","Join, Compete, and Grow: The Pathway to Success!","Seminar on CARRER counselling"];
...
{
	randomplace=Math.floor(Math.random()*9) + 1
